...
export default class Level3 extends BaseScene {
    ...
    create() {
        ...
        obstacles.create(64, 32, 'hollwallbottop').setOrigin(0, 0);
        ...
        obstacles.create(256, 32, 'hollwallbottop').setOrigin(0, 0);
        ...
        obstacles.create(160, 128, 'hollwallbottop').setOrigin(0, 0);
        ...
        obstacles.create(256, 224, 'hollwallbottop').setOrigin(0, 0);
        obstacles.refresh();
        ...
        scraps.create(194, 64, 'object1').setDisplayOrigin(0, 0);
